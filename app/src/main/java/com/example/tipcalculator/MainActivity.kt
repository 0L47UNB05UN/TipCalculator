...
fun TipTimeLayout() {
    ...
    Column(
        ...
        EditNumberField(
            amountInput, R.string.bill_amount, R.drawable.money,
            {amountInput=it}, KeyboardOptions.Default.copy(
        ...
        EditNumberField(
            tipInput, R.string.how_was_the_service, R.drawable.percent,
            {tipInput=it}, KeyboardOptions.Default.copy(
                keyboardType = KeyboardType.Number,
...
@Composable
fun EditNumberField(
    value: String, @StringRes label: Int, @DrawableRes leadingIcon: Int,
